...
<div class="d-flex align-items-center border-bottom">
    <nav class="navbar navbar-expand-lg bg-body-tertiary py-0 px0 mb-0">
        <ul class="navbar navbar-nav px-3">
            ...
            <a href="/profilekomenterbanyak/{{$idacc}}"><li style="border-bottom: dodgerblue solid 1px; width:150px;" class="navbar-item mediaprofile"><button class=" border-0 w-100 btnicon">Most Comment</button></li></a>
        </ul>
    </nav>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-1 itembanget">
                <a href="/detailpost/{{$list->foto->id}}"><button style="width: 200px; height:200px; border:none; "><strong><i style="color: #00000070;" class="fas fa-comment"></i> {{$list->mycount}}</strong></button></a>
